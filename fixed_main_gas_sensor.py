#!/usr/bin/env python3
"""
Enhanced Gas Sensor Array System with Drift Compensation - FIXED VERSION
Solusi untuk mengatasi masalah voltage drift dan prediksi yang tidak konsisten
Version: 2.0 with Drift Compensation - ERROR FIXED
"""
...
class DriftCompensationManager:
    ...
    def is_daily_check_needed(self):
        ...
        # FIXED: Code yang sebelumnya di luar class sekarang di dalam method
...
class EnhancedDatasheetGasSensorArrayV2:
    """Enhanced Gas Sensor Array with Drift Compensation v2.0 - FIXED"""
    ...
    def calibrate_sensors(self, duration=600):  # UPDATED: 10 minutes default
    ...
    def collect_training_data(self, gas_type, duration=300):  # UPDATED: 5 minutes default
...
def main():
    """FIXED: Enhanced main function with drift compensation workflow"""
    gas_sensor = EnhancedDatasheetGasSensorArrayV2()  # FIXED: Now properly defined

    # Load existing calibration if available
    gas_sensor.load_calibration()

    # Load existing model if available
    gas_sensor.load_model()  # FIXED: Now exists in class
    ...
    while True:
        print("\n" + "="*70)
        print("ENHANCED Gas Sensor Array System v2.0 - WITH DRIFT COMPENSATION - FIXED")
        ...
        try:
            ...
            if choice == '1':
                duration = int(input("Calibration duration (seconds, default 600): ") or 600)  # FIXED: 10 min
                ...
                duration = int(input("Collection duration (seconds, default 300): ") or 300)  # FIXED: 5 min
