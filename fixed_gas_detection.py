...
class GasDetectionSystem:
    ...
    def load_config(self, config_file):
        ...
        default_config = {
            ...
            "dataset_file": "merged_dataset.csv.csv",  # Fixed filename
    ...
    def setup_baseline(self):
        ...
        try:
            ...
            expected_columns = ['TGS 2600', 'TGS 2602', 'TGS 2610', 'label']
            actual_columns = df.columns.tolist()
            
            logger.info(f"Dataset columns: {actual_columns}")
    ...
    def train_model(self):
        ...
        try:
            ...
            logger.info(f"Training data shape after cleaning: {X.shape}")
