...
class OptimizedGasSensorArray:
    def __init__(self):
        ...
        try:
            ...
            self.logger.warning("Running in simulation mode - using dummy values")
            self.simulation_mode = True
        
        # Sensor configurations based on datasheets
        self.sensor_config = {
            'TGS2600': {
                'channel': getattr(self, 'tgs2600', None),
            ...
            'TGS2602': {
                'channel': getattr(self, 'tgs2602', None),
            ...
            'TGS2610': {
                'channel': getattr(self, 'tgs2610', None),
        ...
        self.simulation_mode = getattr(self, 'simulation_mode', False)
    ...
    def load_model(self):
        ...
        try:
            ...
            if metadata_path.exists():
                ...
                self.logger.info(f"Training samples: {metadata.get('training_samples', 'Unknown')}")
            else:
                self.logger.info("Model metadata not found, but model loaded successfully")
    ...
    def check_model_status(self):
        ...
        if self.is_model_trained and self.model is not None:
            ...
            self.logger.warning("Model not trained. Please train the model first (option 3)")
            return False
...
def main():
    ...
    print("Version 2.0 - Enhanced & Fixed")
